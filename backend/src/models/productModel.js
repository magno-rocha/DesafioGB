...
const addProduct = async (produto) => {
    const { nome_produto, descricao_produto, preco_produto, qtd_estoque, data_cadastro_produto, categoria_id, imagem } = produto;
    ...
    const [createdProduct] = await connection.query(sql, [nome_produto, descricao_produto, preco_produto, qtd_estoque, '2024/02/21', categoria_id, imagem] );
